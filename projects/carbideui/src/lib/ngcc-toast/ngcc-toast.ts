...
@Component({
  ...
  standalone: true,
  imports: [NgccIcon],
  templateUrl: './ngcc-toast.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class NgccToast implements OnChanges {
  @Input() cfg: NgccToastConfig | undefined = undefined;
  @Output() closed = new EventEmitter<string>();

  // Internal state signals
  private readonly _cfg = signal<NgccToastConfig | undefined>(undefined);
